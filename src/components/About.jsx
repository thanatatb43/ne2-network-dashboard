    ...
    items: [
      {
        ...
        steps: [
          'เปิดเมนู "แผนที่" จากแถบเมนูด้านซ้าย การ์ดสรุปด้านบนแสดงจำนวนสำนักงานแยกตามสถานะ (ออนไลน์ ✓ / ขัดข้อง ! / ไม่ทราบสถานะ ?) เฉพาะสำนักงานที่มีอุปกรณ์เครือข่ายและ IP กดการ์ดเพื่อกรองเฉพาะสถานะนั้น',
          'ใช้ช่องค้นหาและตัวกรอง (จังหวัด / ประเภทสำนักงาน / สถานะ) เพื่อจำกัดเฉพาะสำนักงานที่ต้องการดู ช่องที่มีค่าจะถูกไฮไลท์ และตัวกรองจะถูกจำไว้ใน URL เมื่อรีเฟรชหรือกดย้อนกลับ',
          'คลิกหมุดบนแผนที่เพื่อเปิด popup แสดงข้อมูลสำนักงานและอุปกรณ์เครือข่ายของสำนักงานนั้น หรือใช้รายการสำนักงานข้างแผนที่ (บนมือถือสลับ "แผนที่ / รายการสำนักงาน") แล้วกด "ดูบนแผนที่"',
          'ในกล่อง popup หรือรายการ กด "ดูรายละเอียดอุปกรณ์" เพื่อไปยังหน้ารายละเอียดอุปกรณ์ (สถานะ, ค่า latency ล่าสุด) กดกลับแล้วจะได้แผนที่เดิมพร้อมตัวกรองและตำแหน่งซูมที่ใช้อยู่',
          'กด "ดูหมุดทั้งหมด" เพื่อปรับแผนที่ให้เห็นทุกสำนักงานที่กรองอยู่ และ "เต็มจอ" เพื่อดูแบบเต็มหน้าจอ (กด Esc เพื่อออก)',
          'ข้อมูลอัปเดตอัตโนมัติทุก 1 นาที หากรีเฟรชไม่สำเร็จจะแสดงข้อมูลเดิมพร้อมข้อความเตือนและปุ่ม "ลองใหม่"'
        ]
      },
      {
        ...
        steps: [
          'เปิดเมนู "งบประมาณ" เลือกปีข้อมูล ม.ค.–ธ.ค. เพื่อดูงบที่ได้รับ ยอดใช้สุทธิ คงเหลือ และค่าเฉลี่ย',
          'คลิกการ์ด แท่งกราฟบัญชี หรือแท่งผู้ใช้ เพื่อเปิดรายการที่กรองตามบริบทนั้นทันที มีปุ่มและรายการข้อความสำหรับคีย์บอร์ดด้วย',
          'ค้นหาด้วยปี รหัสบัญชี บัญชีหักล้าง ผู้ใช้ เลขเอกสาร รายละเอียด เดือน และประเภทรายการ แล้วกดค้นหา ล้างตัวกรองทีละรายการได้',
          'ยอดจ่ายเป็นบวก ยอดกลับรายการเป็นลบ ยอดสุทธิรวมทั้งสองส่วน คลิกแท่งหรือจุดกราฟเดือนเพื่อดูรายการเดือนนั้น',
          'ค้นหาในผลลัพธ์จะค้นทุกหน้า พร้อมแสดงความคืบหน้า เรียงข้อมูล เลือกจำนวนแถว และเปิดเลขเอกสารเพื่ออ่านข้อความเต็มได้',
          'ตัวกรองและหน้าตารางอยู่ใน URL รองรับรีเฟรชและ Back/Forward บนมือถือเลื่อนเฉพาะตารางเพื่อดูทุกคอลัมน์'
        ]
      }
    ]
  },
