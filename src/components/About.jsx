    ...
    items: [
      ...
      },
      {
        ...
        steps: [
          ...
          'เลือกประเภทสำนักงาน หรือค้นหาด้วยชื่อสำนักงาน จังหวัด IP หรือ up / down และกด "ล้างตัวกรอง" เพื่อดูทั้งหมด',
          ...
          'กดชื่อสำนักงานเพื่อดูรายละเอียด เมื่อกลับมาหรือรีเฟรชในแท็บเดิม ระบบจะจำคำค้น ประเภทสำนักงาน การเรียงลำดับ จำนวนรายการต่อหน้า และหน้าตาราง พร้อมโหลดข้อมูลล่าสุด',
    ...
    items: [
      {
        ...
        steps: [
          ...
          'ใช้ช่องค้นหาและตัวกรอง (ประเภท / แผนก / สถานะ / สำนักงาน) เพื่อหาอุปกรณ์ที่ต้องการ — ช่องกรองประเภท/แผนก/สำนักงานพิมพ์ค้นหาได้ ต้องพิมพ์หรือเลือกให้ตรงกับรายการที่ขึ้นแนะนำเป๊ะๆ ระบบจึงจะกรองตามนั้นได้',
    ...
    items: [
      {
        ...
        steps: [
          'เปิดเมนู "แจ้งปัญหา" — ดูรายการงานที่แจ้งไว้ทั้งหมดพร้อมสถานะได้ทันทีโดยไม่ต้องเข้าสู่ระบบ',
          'ใช้ช่องค้นหาและตัวกรอง (สำนักงาน / สถานะ / ประเภทงาน / ความสำคัญ) เพื่อหารายการที่ต้องการ — ช่องกรองสำนักงานพิมพ์ค้นหาได้ ต้องพิมพ์หรือเลือกชื่อให้ตรงกับรายการที่ขึ้นแนะนำเป๊ะๆ ระบบจึงจะกรองตามสำนักงานนั้นได้',
          'คลิกแถวรายการเพื่อดูรายละเอียด (สถานะ ผู้แจ้ง อุปกรณ์ที่มีปัญหา) — ถ้ามีไฟล์หนังสือแจ้งแนบไว้ จะแสดงในหน้ารายละเอียดทันที (รูปภาพแสดงเป็นรูป, PDF แสดงเป็นกล่อง preview ขนาดเล็ก) — คลิกรูปภาพหรือกล่อง PDF เพื่อดูแบบเต็มจอในหน้าเดิม ไม่เปิดแท็บใหม่ และเลื่อนดูรูปหลังดำเนินการรูปถัดไป/ก่อนหน้าได้ในหน้าเดียวกัน',
          'หน้ารายละเอียดยังแสดงข้อมูลตามสถานะเพิ่มเติมด้วย เช่น วันที่เปิดงาน/อัปเดตล่าสุด, ผู้รับผิดชอบและเลขที่คำสั่งปฏิบัติงาน (เมื่อเริ่มดำเนินการแล้ว), หมายเหตุปิดงาน หรือเหตุผลที่ยกเลิก',
          'เมื่องานเสร็จแล้ว หน้ารายละเอียดจะแสดงอุปกรณ์ที่ใช้ดำเนินการ รูปหลังดำเนินการ และธุรกรรมงบประมาณที่ผูกไว้ด้วย',
