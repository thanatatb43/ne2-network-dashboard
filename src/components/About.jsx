    ...
    items: [
      ...
      },
      {
        ...
        steps: [
          ...
          'คลิกที่แถวอุปกรณ์เพื่อดูรายละเอียดทั้งหมดของชิ้นนั้น',
    ...
    items: [
      {
        ...
        steps: [
          ...
          'คลิกแถวรายการเพื่อดูรายละเอียด (สถานะ ผู้แจ้ง อุปกรณ์ที่มีปัญหา) — ถ้ามีไฟล์หนังสือแจ้งแนบไว้ จะแสดงรูปภาพ/PDF ให้ดูได้ทันทีในหน้ารายละเอียด',
    ...
    items: [
      ...
      },
      {
        ...
        steps: [
          ...
          'หากมีไฟล์หนังสือแจ้งแนบไว้ จะแสดงรูปภาพ/PDF ให้ดูได้ทันทีในหน้ารายละเอียดงาน',
