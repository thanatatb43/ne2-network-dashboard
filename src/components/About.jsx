    ...
    items: [
      {
        ...
        desc: 'ทดสอบความเร็วถึงเซิร์ฟเวอร์ของระบบ และตรวจสอบการตอบสนองของปลายทาง (ต้องเข้าสู่ระบบ)',
        steps: [
          'เข้าสู่ระบบก่อน จึงจะเห็นเมนูนี้ หน้านี้ไม่เริ่มทดสอบความเร็วเองเมื่อเปิดหรือกดย้อนกลับ',
          'ส่วน "ข้อมูลการเชื่อมต่อ" แสดง Public IP (จากบริการภายนอก) ไอพีที่เซิร์ฟเวอร์เห็น ชื่อเครื่อง และ MAC Address กด "คัดลอก" เพื่อคัดลอกค่า หากโหลดส่วนใดไม่สำเร็จจะมีปุ่ม "ลองใหม่" เฉพาะส่วนนั้น และ "ไม่ทราบ" หมายถึงระบบไม่มีข้อมูล',
          'สถานะปลายทาง (PEA HQ / กฟฉ.2 / อินเทอร์เน็ต) ตรวจด้วย ping จากเซิร์ฟเวอร์ทุก 30 วินาที แสดงเป็น ตอบสนอง ✓ / ไม่ตอบสนอง ! / ตรวจสอบไม่ได้ ? / ยังไม่ได้ตรวจสอบ — การไม่ตอบสนองไม่ได้ยืนยันว่าอุปกรณ์เสีย หากอัปเดตล้มเหลวจะแสดงผลล่าสุดพร้อมเวลา',
          'กด "เริ่มทดสอบความเร็ว" เพื่อวัดเวลาตอบกลับ, Download และ Upload ระหว่างเบราว์เซอร์กับเซิร์ฟเวอร์ของระบบ กด "หยุดการทดสอบ" ได้ตลอด (ค่าที่ได้เป็นผลบางส่วนและไม่บันทึกรายงาน) เมื่อเสร็จระบบบันทึกรายงานให้ และแจ้งสถานะการบันทึก',
          'เมื่อกลับเข้าหน้านี้จะเห็น "ผลครั้งก่อน" พร้อมเวลาและไอพีที่กรอกไว้ (เก็บเฉพาะในแท็บนี้) โดยไม่ทดสอบซ้ำเอง',
          'ช่อง "ตรวจสอบสถานะไอพี" รองรับ IPv4 กด Enter หรือปุ่ม "ตรวจสอบ" ผลจะระบุว่าเป็นของไอพีใด พร้อม latency, packet loss และเวลาตรวจ'
        ]
      },
      {
      ...
      },
      {
        ...
        steps: [
          ...
          'เปิดชื่อในอันดับหรือตารางเพื่อดูอุปกรณ์ แล้วกลับมาพร้อมตัวกรอง หน้า และตำแหน่งเดิม อุปกรณ์ที่ถูกลบยังอ่านข้อมูลเหตุการณ์ที่มีอยู่ได้',
          'Desktop เรียงรายการด้วยหัวตาราง; mobile ใช้ตัวเลือกเรียงเหนือการ์ด เปลี่ยนหน้าด้วยก่อนหน้า/ถัดไป หรือพิมพ์เลขหน้าแล้วกด Enter; ดูระยะเวลาภายในช่วงได้ในข้อมูลเหตุการณ์',
          'กด "รีเฟรชข้อมูล" เพื่ออ่านชุดข้อมูลใหม่ เมื่อข้อมูลชุดเดิมหมดอายุระบบจะแจ้งให้โหลดใหม่ หากบางส่วนล้มเหลวให้กด "ลองใหม่" โดยไม่ต้องกรอกเงื่อนไขใหม่'
        ]
      },
      {
        name: 'อุปกรณ์ทั้งหมด',
