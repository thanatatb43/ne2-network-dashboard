...
// so viewing never leaves the job detail page. type='pdf' renders a
...
const JobManagement = ({ token, onBack, user }) => {
  ...
  return (
    ...
    >
      ...
      {/* ----------------------------------------------------
          In-page photo viewer -- notification doc / completion report
          images and the after-photos gallery all open here instead of a
          new tab.
          ---------------------------------------------------- */}
      <AnimatePresence>
        {lightboxImages && (
