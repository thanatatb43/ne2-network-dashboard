...
อ่าน [มาตรฐาน UX/UI ของโปรเจกต์](DESIGN_STANDARDS.md) ก่อนเพิ่มหน้าใหม่หรือปรับ UI โดยใช้หน้า Devices เป็นตัวอย่างนำร่อง ครอบคลุมรูปแบบหน้าจอ สี ปุ่ม ฟอร์ม ตาราง สถานะข้อมูล และการจำบริบทเมื่อกลับหน้าเดิม
